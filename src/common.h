...
static const int PACK_IN_MEM_LIMIT = 256;
...
static const int FAIL_CHIMERA = 22;
...
const static char* FAILED_TYPES[FILTER_RESULT_TYPES] = {
	...
	"failed_quality_filter", "failed_gc_content_filter", "failed_chimeric_read", "",
