...
int main(int argc, char* argv[]){
    ...
    cmd.add<int>("max_len", 'b', "if read is longer than max_len, then trim read at its tail to make it as long as max_len. Default 0 means no limitation", false, 0);
    ...
    opt.trim.maxLen = cmd.get<int>("max_len");
